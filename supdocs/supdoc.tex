...
\begin{figure}[h!]
%S22
\includegraphics[width=\textwidth]{testhighlats.png}\\
\caption{Histogram of soy yields north of 45$^o$ latitude for the PROMET model. Black bars show the historical climatology and red bars show the T+4 (K) case. Note strong reduction in the lowest bin for the T+4 case.}
\label{fig:highlat}
\end{figure}

\begin{figure}[h!]
%S22
\includegraphics[width=\textwidth]{testhighlats2.png}\\
\caption{Same as above for LPJmL soy.}
\label{fig:highlat}
\end{figure}
