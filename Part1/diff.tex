...
%DIF ADD main1.tex            Fri Mar 13 14:59:55 2020
...
}\DIFaddend Long-term projections therefore retain considerable uncertainty \DIFdelbegin \DIFdel{\mbox{%DIFAUXCMD
\citep{WOLF2002217, JAGTAP200273, Iizumi2010, ANGULO201332, Asseng2013, Asseng2015}}\hspace{0pt}%DIFAUXCMD
...
, and irrigated and rainfed cases  
 are both simulated with near-global coverage. %DIF > , independent of their actual occurrence. 
...
\DIFdelbegin \DIFdel{Because harvest dates are a function of climate parameters , simulations with the harmonized phenological parameters described above generally result in shorter }\DIFdelend \DIFaddbegin \DIFadd{The dependence of harvest dates on climate parameters means that in a model with phenological parameters tuned to match target }\DIFaddend growing seasons in \DIFdelbegin \DIFdel{future warmer scenarios}\DIFdelend \DIFaddbegin \DIFadd{the baseline climate, growing seasons will nevertheless alter under climate change. In general, warmer future scenarios produce shorter growing seasons}\DIFaddend .
...
\DIFadd{The twelve models participating }\DIFaddend in GGCMI Phase \DIFdelbegin \DIFdel{II provide 7 mandatory output variables if available (Table \ref{table:outputs}, bold}\DIFdelend \DIFaddbegin \DIFadd{2 are listed in Table \ref{table:models}. 
...
\begin{table*}[t]
\caption{
\DIFaddFL{Models included in GGCMI Phase 2 and the number of CTWN-A simulations performed. 
...
\label{table:models}
  \begin{tabular}{p{6cm} p{1cm} p{1cm} p{1cm} p{1cm} p{1cm} p{1cm} p{1.9cm}}
    \tophline
    {\textbf{\DIFaddFL{Model (Key Citations)}}}&{\textbf{\DIFaddFL{Maize}}}&{\textbf{\DIFaddFL{Soybean}}}&{\textbf{\DIFaddFL{Rice}}}&{\textbf{\DIFaddFL{Winter wheat}}}&{\textbf{\DIFaddFL{Spring wheat}}}&{\textbf{\DIFaddFL{N dim.}}}&{\textbf{\DIFaddFL{Sims per crop (A0 / A1)}}}\\ \middlehline
    {\textbf{\DIFaddFL{APSIM-UGOE}}\DIFaddFL{,    \mbox{%DIFAUXCMD
\citet{KEATING2003267, HOLZWORTH2014327}}\hspace{0pt}%DIFAUXCMD
}} & {\DIFaddFL{X}} & {\DIFaddFL{X}} & {\DIFaddFL{X}} & {\DIFaddFL{--}} & {\DIFaddFL{X}} & {\DIFaddFL{X}} & {\DIFaddFL{44 / 36}}\\ \middlehline
    {\textbf{\DIFaddFL{CARAIB}}\DIFaddFL{,        \mbox{%DIFAUXCMD
\citet{Dury2011, Pirttioja2015}}\hspace{0pt}%DIFAUXCMD
}}  & {\DIFaddFL{X}} & {\DIFaddFL{X}} & {\DIFaddFL{X}} & {\DIFaddFL{X}} & {\DIFaddFL{X}} & {\DIFaddFL{--}} & {\textbf{\DIFaddFL{252 / 216}}}\\ \middlehline
    {\textbf{\DIFaddFL{EPIC-IIASA}}\DIFaddFL{,    \mbox{%DIFAUXCMD
\citet{BALKOVIC2014}}\hspace{0pt}%DIFAUXCMD
}} & {\DIFaddFL{X}} & {\DIFaddFL{X}} & {\DIFaddFL{X}} & {\DIFaddFL{X}} & {\DIFaddFL{X}} & {\DIFaddFL{X}} & {\DIFaddFL{39 / 0}}\\  \middlehline
    {\textbf{\DIFaddFL{EPIC-TAMU}}\DIFaddFL{,     \mbox{%DIFAUXCMD
\citet{Izaurralde06}}\hspace{0pt}%DIFAUXCMD
}} & {\DIFaddFL{X}} & {\DIFaddFL{X}} & {\DIFaddFL{X}} & {\DIFaddFL{X}} & {\DIFaddFL{X}} & {\DIFaddFL{X}} & {\textbf{\DIFaddFL{756 / 648}}}\\ \middlehline
    {\textbf{\DIFaddFL{JULES}}\DIFaddFL{,         \mbox{%DIFAUXCMD
\citet{Osborne2015, Williams2015, Williams2017}}\hspace{0pt}%DIFAUXCMD
}} & {\DIFaddFL{X}} & {\DIFaddFL{X}} & {\DIFaddFL{X}} & {\DIFaddFL{--}} & {\DIFaddFL{X}} & {\DIFaddFL{--}} & {\textbf{\DIFaddFL{252 / 0}}}\\ \middlehline
    {\textbf{\DIFaddFL{GEPIC}}\DIFaddFL{,         \mbox{%DIFAUXCMD
\citet{LIU2007478, FOLBERTH201221}}\hspace{0pt}%DIFAUXCMD
}} & {\DIFaddFL{X}} & {\DIFaddFL{X}} & {\DIFaddFL{X}} & {\DIFaddFL{X}} & {\DIFaddFL{X}} & {\DIFaddFL{X}} & {\DIFaddFL{430 / 181}}\\ \middlehline
    {\textbf{\DIFaddFL{LPJ-GUESS}}\DIFaddFL{,     \mbox{%DIFAUXCMD
\citet{Lindeskog2013, Olin2015}}\hspace{0pt}%DIFAUXCMD
}} & {\DIFaddFL{X}} & {\DIFaddFL{--}} & {\DIFaddFL{--}} & {\DIFaddFL{X}} & {\DIFaddFL{X}} & {\DIFaddFL{X}} & {\textbf{\DIFaddFL{756 / 648}}}\\  \middlehline
    {\textbf{\DIFaddFL{LPJmL}}\DIFaddFL{,         \mbox{%DIFAUXCMD
\citet{von_Bloh_implementing_2018}}\hspace{0pt}%DIFAUXCMD
}} & {\DIFaddFL{X}} & {\DIFaddFL{X}} & {\DIFaddFL{X}} & {\DIFaddFL{X}} & {\DIFaddFL{X}} & {\DIFaddFL{X}} & {\textbf{\DIFaddFL{756 / 648}}}\\ \middlehline
    {\textbf{\DIFaddFL{ORCHIDEE-crop}}\DIFaddFL{, \mbox{%DIFAUXCMD
\citet{Wu2016}}\hspace{0pt}%DIFAUXCMD
}} & {\DIFaddFL{X}} & {\DIFaddFL{--}}  & {\DIFaddFL{X}} & {\DIFaddFL{X}} & {\DIFaddFL{--}} & {\DIFaddFL{X}} & {\DIFaddFL{33 / 0}}\\ \middlehline
    {\textbf{\DIFaddFL{pDSSAT}}\DIFaddFL{,        \mbox{%DIFAUXCMD
\citet{Elliott2014b, JONES2003235}}\hspace{0pt}%DIFAUXCMD
}} & {\DIFaddFL{X}} & {\DIFaddFL{X}} & {\DIFaddFL{X}} & {\DIFaddFL{X}} & {\DIFaddFL{X}} & {\DIFaddFL{X}} & {\textbf{\DIFaddFL{756 / 648}}}\\ \middlehline
    {\textbf{\DIFaddFL{PEPIC}}\DIFaddFL{,         \mbox{%DIFAUXCMD
\citet{LIU2016164, LIU2016}}\hspace{0pt}%DIFAUXCMD
}}  & {\DIFaddFL{X}} & {\DIFaddFL{X}} & {\DIFaddFL{X}} & {\DIFaddFL{X}} & {\DIFaddFL{X}} & {\DIFaddFL{X}} & {\DIFaddFL{149 / 121}}\\ \middlehline
    {\textbf{\DIFaddFL{PROMET}}\DIFaddFL{,        \mbox{%DIFAUXCMD
\citet{Hank2015, MAUSER2015}}\hspace{0pt}%DIFAUXCMD
}} & {\DIFaddFL{X}} & {\DIFaddFL{X}} & {\DIFaddFL{X}} & {\DIFaddFL{X}} & {\DIFaddFL{X}} & {\DIFaddFL{X}} & {\DIFaddFL{261 / 232}}\\ \middlehline
    {\DIFaddFL{Totals}} & {\DIFaddFL{12}} & {\DIFaddFL{10}} & {\DIFaddFL{11}} & {\DIFaddFL{10}} & {\DIFaddFL{11}} & {\DIFaddFL{10}} & {\DIFaddFL{5240 | 3378}}\\
    \bottomhline
  \end{tabular}
\end{table*}

\DIFadd{Table \ref{table:models} also descibes the simulation output contibution of each model to the GGCMI Phase 2 archive.
...
These subsets were designed as alternate samples across the 4 dimensions of the CTWN space,with }\textit{\DIFadd{full}} \DIFadd{(12) and }\textit{\DIFadd{low}} \DIFadd{(4) options for the C $\cdot$ N variables, and }\textit{\DIFadd{full}} \DIFadd{(63), }\textit{\DIFadd{reduced}} \DIFadd{(31), and }\textit{\DIFadd{minimum}} \DIFadd{(9) options for T $\cdot$ W variables (described below). 
...
\DIFadd{The different participation levels are defined by combining the CxN sets with the TxW sets:
}\begin{itemize}
...
\noindent \DIFadd{Of the 12 models submitting data, 6 followed the }\textit{\DIFadd{full}} \DIFadd{protocol; these are marked with bold text in the last column of Table \ref{table:models}. 
...
Two models followed }\textit{\DIFadd{high}} \DIFadd{with minor modifications (GEPIC adding an additional T level and PROMET omitting the intermediate N level). 
One model (PEPIC) followed }\textit{\DIFadd{mid}} \DIFadd{but included an additional C level. 
Three models approximately followed }\textit{\DIFadd{low}} \DIFadd{with APSIM-UGOE and EPIC-IIASA providing some additional TxW levels and ORCHIDEE-crop omitting some TxW combinations.  
}

\DIFadd{The combinations of perturbation values in the CxN and TxW parameter spaces used in the various participation levels are chosen to provide maximum coverage over plausible future values. For the CxN space, we specify:
}\begin{itemize}
  \item \textit{\DIFadd{full}} \DIFadd{as 12 pairs, with 4 C values (360, 510, 660, 810 ppm) and 3 N (10, 60, 200 kg ha$^{-1}$ yr$^{-1}$}\DIFaddend )
  \DIFdelbegin \DIFdel{.
For each scenario, 0.5 degree grid cell and crop, models }\DIFdelend \DIFaddbegin \item \textit{\DIFadd{low}} \DIFadd{as only 4 pairs: C360\_N10, C360\_N200, C660\_N60, C810\_N200
}\end{itemize}

\DIFadd{For the TxW space we specify:
}\begin{itemize}
  \item \textit{\DIFadd{full}} \DIFadd{as all 7 T levels and 9W levels.
  }\item \textit{\DIFadd{reduced}} \DIFadd{as 31 alternating combinations, with different Ws for even Ts than for odd Ts. For even Ts (i.e.\ T0,T2,T4,T6), we use W = -50,-20,0,+30 = 4$\cdot$4 = 16 pairs. For odd Ts (i.e.\ T-1,T1,T3) , we use W = -30, -10, +10, +30, inf = 3$\cdot$5 = 15 pairs.
  }\item \textit{\DIFadd{minimum}} \DIFadd{as 9 combinations: T-1W-10, T0W10, T1W-30, T2W-50, T2W20, T3W30, T4W0, T4Winf, T6W-20
}\end{itemize}

\section{\DIFadd{Output data products}}
\DIFadd{All models in GGCMI Phase 2 }\DIFaddend provide 30-year timeseries of annual crop yields 
\DIFaddbegin \DIFadd{for each scenario, 0.5 degree grid cell and crop, }\DIFaddend in units of tons ha$^{-1}$ year$^{-1}$\DIFdelbegin \DIFdel{, as well as }\DIFdelend \DIFaddbegin \DIFadd{. They also provide all available variables of the following 6: }\DIFaddend total aboveground biomass yield; the dates of planting, anthesis \DIFdelbegin \DIFdel{, }\DIFdelend and maturity; applied irrigation water in irrigated scenarios; and total \DIFdelbegin \DIFdel{evapotranspirtation. 
...
%DIFAUXCMD
%DIFDELCMD < \label{table:models}
%DIFDELCMD <   \begin{tabular}{p{6cm} p{1cm} p{1cm} p{1cm} p{1cm} p{1cm} p{1cm} p{1.9cm}}
%DIFDELCMD <     \tophline
%DIFDELCMD <     {%%%
\textbf{\DIFdelFL{Model (Key Citations)}}%DIFAUXCMD
%DIFDELCMD < }&{%%%
...
%DIFDELCMD < }&{%%%
\textbf{\DIFdelFL{N dim.}}%DIFAUXCMD
%DIFDELCMD < }&{%%%
\textbf{\DIFdelFL{Sims per crop (A0 / A1)}}%DIFAUXCMD
...
\DIFdelFL{X}%DIFDELCMD < } & {%%%
\DIFdelFL{X}%DIFDELCMD < } & {%%%
\DIFdelFL{44 / 36}%DIFDELCMD < }\\ \middlehline
%DIFDELCMD <     {%%%
...
\DIFdelFL{X}%DIFDELCMD < } & {%%%
\DIFdelFL{--}%DIFDELCMD < } & {%%%
\textbf{\DIFdelFL{252 / 216}}%DIFAUXCMD
%DIFDELCMD < }\\ \middlehline
%DIFDELCMD <     {%%%
...
\DIFdelFL{X}%DIFDELCMD < } & {%%%
\DIFdelFL{X}%DIFDELCMD < } & {%%%
\DIFdelFL{39 / 0}%DIFDELCMD < }\\  \middlehline
%DIFDELCMD <     {%%%
...
\DIFdelFL{X}%DIFDELCMD < } & {%%%
\DIFdelFL{X}%DIFDELCMD < } & {%%%
\textbf{\DIFdelFL{756 / 648}}%DIFAUXCMD
%DIFDELCMD < }\\ \middlehline
%DIFDELCMD <     {%%%
...
\DIFdelFL{X}%DIFDELCMD < } & {%%%
\DIFdelFL{--}%DIFDELCMD < } & {%%%
\textbf{\DIFdelFL{252 / 0}}%DIFAUXCMD
%DIFDELCMD < }\\ \middlehline
%DIFDELCMD <     {%%%
...
\DIFdelFL{X}%DIFDELCMD < } & {%%%
\DIFdelFL{X}%DIFDELCMD < } & {%%%
\DIFdelFL{430 / 181}%DIFDELCMD < }\\ \middlehline
%DIFDELCMD <     {%%%
...
\DIFdelFL{--}%DIFDELCMD < } & {%%%
\DIFdelFL{X}%DIFDELCMD < } & {%%%
\DIFdelFL{33 / 0}%DIFDELCMD < }\\ \middlehline
%DIFDELCMD <     {%%%
...
\DIFdelFL{X}%DIFDELCMD < } & {%%%
\DIFdelFL{X}%DIFDELCMD < } & {%%%
\DIFdelFL{149 / 121}%DIFDELCMD < }\\ \middlehline
%DIFDELCMD <     {%%%
...
\DIFdelFL{X}%DIFDELCMD < } & {%%%
\DIFdelFL{X}%DIFDELCMD < } & {%%%
\DIFdelFL{261 / 232}%DIFDELCMD < }\\ \middlehline
%DIFDELCMD <     {%%%
\DIFdelFL{Totals}%DIFDELCMD < } & {%%%
...
Not all modeling groups provided simulations for the full protocol described above. 
Given the substantial computational requirements, different participation tiers were specified to allow submission of smaller sub-sets of the full protocol. 
These subsets were designed as alternate samples across the 4 dimensions of the CTWN space,with }\textit{\DIFdel{full}} %DIFAUXCMD
\DIFdel{(12) and }\textit{\DIFdel{low}} %DIFAUXCMD
\DIFdel{(4) options for the C $\cdot$ N variables, and }\textit{\DIFdel{full}} %DIFAUXCMD
\DIFdel{(63), }\textit{\DIFdel{reduced}} %DIFAUXCMD
\DIFdel{(31), and }\textit{\DIFdel{minimum}} %DIFAUXCMD
...
%DIFDELCMD <   \item{\textbf{full}: all 756 A0 simulations (all 12 CxN * all 63 TxW)}
%DIFDELCMD <   \item{\textbf{high}: 362 simulations (all 12 CxN combinations  $\cdot$ \textit{reduced} TxW set of 31 combinations)}
%DIFDELCMD <   \item{\textbf{mid}: 124 simulations (\textit{low} 4 CxN combinations $\cdot$ \textit{reduced} TxW set of 31 combinations)}
%DIFDELCMD <   \item{\textbf{low}: 36 simulations (\textit{low} 4 CxN combinations $\cdot$ \textit{minimum} TxW set of 9 combinations)}
...
%DIFDELCMD < \noindent %%%
\DIFdel{Of the 12 models submitting data, 6 followed the }\textit{\DIFdel{full}} %DIFAUXCMD
\DIFdel{protocol; these are marked with italic text in Table \ref{table:models}. 
However, note that two of these models (CARAIB and JULES) cannot represent nitrogen effects explicitly and so do not sample over the nitrogen dimension. 
Two models followed }\textit{\DIFdel{high}} %DIFAUXCMD
\DIFdel{with minor modifications (GEPIC adding an additional T level and PROMET omitting the intermediate N level). 
One model (PEPIC) followed }\textit{\DIFdel{mid}} %DIFAUXCMD
\DIFdel{but included an additional C level. 
Three models approximately followed }\textit{\DIFdel{low}} %DIFAUXCMD
...
\item%DIFAUXCMD
\textit{\DIFdel{reduced}} %DIFAUXCMD
...
\item%DIFAUXCMD
\textit{\DIFdel{minimum}} %DIFAUXCMD
...
\citep{muller_global_2017} }\hspace{0pt}%DIFAUXCMD
or have later used that online tool for the evaluation of subsequent model versions \mbox{%DIFAUXCMD
...
We provide a partial evaluation of the models’ skill in reproducing crop yield characteristics using the methodology of \citet{muller_global_2017}, developed for GGCMI Phase \DIFdelbegin \DIFdel{I.
...
\DIFdelbegin \DIFdel{Models }\DIFdelend \DIFaddbegin \DIFadd{In the A0 simulation, models }\DIFaddend show robust decreases in yields at low latitudes, and highly uncertain ensemble mean increases at most high latitudes.
\DIFaddbegin \DIFadd{Low latitude yield reductions are due in part to shortenting of the growing season under warming and in part to the direct effects of higher temperature.
...
}\DIFaddend Models show some increases in high mountain regions that are currently cold-limited \DIFaddbegin \DIFadd{in both A0 and A1 simulations}\DIFaddend .
...
We illustrate a few of these relationships in Figures \ref{fig:maizerice}-\ref{fig:soywheat} \DIFdelbegin \DIFdel{, choosing }\DIFdelend \DIFaddbegin \DIFadd{using A0 simualtions to capture maximum effect.
We choose }\DIFaddend crops and factors whose effects are reasonably well understood. 
...
The responses highlighted here are qualitatively similar across all crops included in this study (Supplemental Figures S5 - \DIFdelbegin \DIFdel{S8}\DIFdelend \DIFaddbegin \DIFadd{S9 for all simulated area and S10 - S13 for cultivated area only}\DIFaddend ). 
...
\DIFaddbegin \DIFadd{As noted previously, the adaptation simulations involve significatly reduced climate impacts compared to A0 simulastions shown here. 
...
In validation tests of simulations of the historical scenario, year-over-year correlations in modeled and actual country-level yields are similar to those of GGCMI Phase \DIFdelbegin \DIFdel{I. }\DIFdelend \DIFaddbegin \DIFadd{1. 
}\DIFaddend In simulations on scenarios with perturbed climate and management factors, models generally agree on changes driven outside the high latitudes, with changes at nearly all perturbation levels exceeding the inter-model spread. \DIFdelbegin \DIFdel{(}\DIFdelend At high latitudes, differences are often driven by differences in model treatment of crop response to current cold conditions. 
\DIFdelbegin \DIFdel{) 
}\DIFdelend In simulations with multiple perturbations, interactions between major yield drivers (temperature and precipitation in Figure \ref{fig:maizerice}, precipitation and CO$_2$ in Figure \ref{fig:soywheat}) generally follow expectations and produce physically reasonable responses in crop yields.
...
GGCMI Phase \DIFdelbegin \DIFdel{II }\DIFdelend \DIFaddbegin \DIFadd{2 }\DIFaddend is intended as a study of model-projected changes under broad climate change, which may not be as sensitive to the adjustments needed to reproduce present-day yields. 
...
\DIFdelbegin \DIFdel{GGCMI Phase II }\DIFdelend \DIFaddbegin \DIFadd{As such it also remains challenging to evaluate model performance as the actual growing conditions have to be interpolated between the uniform input levels used in the GGCMI Phase 2 setup. 
GGCMI Phase 2 }\DIFaddend simulation results can be used for impacts projection, but only with the construction of an emulator of crop yield response to climatological changes, that is then driven by a realistic climate projection.
\DIFdelbegin \DIFdel{However, note that }\DIFdelend \DIFaddbegin \DIFadd{Note that while }\DIFaddend the experiment does not sample over potential changes in the higher-order moments in the distributions in temperature and precipitation\DIFaddbegin \DIFadd{, we shown these higher-order changes matter little for an impact assessment under a transient climate run such as an RCP from CMIP-5 when conducted with emulators developed from the GGCMI Phase 2 simulations \mbox{%DIFAUXCMD
\citep{Franke2020}}\hspace{0pt}%DIFAUXCMD
}\DIFaddend .

\DIFaddbegin \DIFadd{XXX -separate paragraph?? A final caveat is that since simulations are run off-line and therefore do not contain any feedbacks between the atmosphere and land such as irrigation impacts on humidity.
...
While we acknowledge that these mechanisms exist \mbox{%DIFAUXCMD
\citep[e.g.][]{Decker2017}}\hspace{0pt}%DIFAUXCMD
, these feedbacks need to be explored in more specialized analyzes, as they require an Earth-system model analysis framework, which is in conflict with the design of systematic offsets in climatic drivers.
}
...
Potential applications include, as mentioned, the construction of emulators and yield response surface, as well as studies of issues such as the benefits of adaptation \DIFaddbegin \DIFadd{(including parsing to what degree yeild losses are due to shortenting growing seasons or the direct effects of higher temperture)}\DIFaddend , interactions between the CTWN factors affecting yield \DIFaddbegin \DIFadd{--especially between CO$_2$ and water}\DIFaddend , changes in nitrogen use efficiency, geographic shifts in regional production, investigation of core sensitivities to \DIFdelbegin \DIFdel{CTWN/A }\DIFdelend \DIFaddbegin \DIFadd{CTWN-A }\DIFaddend by region and farm system, identification of hotspots of crop system vulnerability, rapid assessment of new climate projections, and many others. 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{sloppypar}
\DIFdelbegin %DIFDELCMD < \codedataavailability{The simulation outputs of the mandatory 7 output variables (Table \ref{table:outputs}) are available on zenodo.org. 
...
%DIFDELCMD < }
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \codedataavailability{The simulation outputs of the mandatory 7 output variables (Table \ref{table:outputs}) are available on zenodo.org. 
