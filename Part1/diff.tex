...
%DIF ADD main1.tex            Fri Mar 13 16:26:30 2020
...
First, absolute model yield values in the \DIFdelbegin \DIFdel{historical }\DIFdelend \DIFaddbegin \DIFadd{baseline }\DIFaddend scenario will generally not match observed yields. 
...
\citep{Elliott2015}}\hspace{0pt}%DIFAUXCMD
. 
GGCMI Phase II }\DIFdelend \DIFaddbegin \DIFadd{GGCMI Phase 2 }\DIFaddend is intended as a study of model-projected changes under \DIFdelbegin \DIFdel{broad }\DIFdelend \DIFaddbegin \DIFadd{future }\DIFaddend climate change, which \DIFdelbegin \DIFdel{may not be as sensitive }\DIFdelend \DIFaddbegin \DIFadd{are assumed insensitivee }\DIFaddend to the adjustments needed to reproduce present-day yields. 
\DIFdelbegin \DIFdel{Note however that the models used in this exercise cannot simulate some potential climate-related yield changes: those due to factors such as pests, diseases, and weeds. }\DIFdelend \DIFaddbegin \DIFadd{The historical scenario also includes no trend in CO$_2$, and no individual case involves realistic country-specific nitrogen application levels \mbox{%DIFAUXCMD
\citep{Elliott2015}}\hspace{0pt}%DIFAUXCMD
. (The baseline value is defined as 200 kg ha$^{-1}$.)
}\DIFaddend 
...
Such emulators are shown to accurately reproduce crop model output under realistic climate projections, even though the GGCMI Phase II }\DIFaddend experiment
