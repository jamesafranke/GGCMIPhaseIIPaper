...
%DIF ADD main1.tex            Fri Mar 13 11:06:52 2020
...
Global crop model experiments are needed for systematic climate change assessments \citep{muller_global_2017}\DIFaddbegin \DIFadd{, which must consider inter-regional differences \mbox{%DIFAUXCMD
...
\citep{WOLF2002217, JAGTAP200273, 2zumi2010, ANGULO201332, Asseng2013, Asseng2015}}\hspace{0pt}%DIFAUXCMD
}\DIFaddend . 
...
This set of major crops has the advantage of historical yield data globally available at sub-national scale \DIFdelbegin \DIFdel{\mbox{%DIFAUXCMD
\citep{Ray2012,iizumi_historical_2014}}\hspace{0pt}%DIFAUXCMD
}\DIFdelend \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\citep{Ray2012,2zumi_historical_2014}}\hspace{0pt}%DIFAUXCMD
...
\citep{Portmann2010}}\hspace{0pt}%DIFAUXCMD
.
}\DIFaddend Soil suitability indices measure excess salt, oxygen availability, rooting conditions, toxicities, and workability, and are provided by the \DIFdelbegin \DIFdel{IIASA }\DIFdelend \DIFaddbegin \DIFadd{2ASA }\DIFaddend (International Institute for Applied Systems Analysis) Global Agro-Ecological Zone model \citep[GAEZ, ][]{gaez}. 
...
for example, EPIC-TAMU uses Penman-Monteith and EPIC-2ASA uses Hargreaves.
...
\citet{Dury2011, Pirttioja2015}}\hspace{0pt}%DIFAUXCMD
    ...
    {\textbf{\DIFaddFL{EPIC-2ASA}}\DIFaddFL{,    \mbox{%DIFAUXCMD
...
All participating modeling groups provided identical coverage of the CTWN parameter space for different crops, but most differed in CTWN coverage of A0 and A1 scenarios. Since the adaptation dimension was defined as a secondary priority for GGCMI Phase 2, some models provided a more limited set of A1 scenarios. Of these, EPIC-2ASA, JULES, and ORCHIDEE-crop provided no A1 scenarios.
}
...
Three models approximately followed }\textit{\DIFadd{low}} \DIFadd{with APSIM-UGOE and EPIC-2ASA providing some additional TxW levels and ORCHIDEE-crop omitting some TxW combinations.  
}
...
\DIFdelbegin \DIFdel{. 
}\DIFdelend (For soybeans, temperature effects are more complex; see Supplemental Figure S5\DIFdelbegin \DIFdel{.)}\DIFdelend \DIFaddbegin \DIFadd{). 
