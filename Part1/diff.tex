...
%DIF ADD main1.tex            Fri Mar 13 19:19:11 2020
...
\DIFaddbegin \DIFadd{All models participating in GGCMI Phase 2 have be evaluated against historical yields and site specific experimental data.
...
\DIFdelbegin \DIFdel{Models }\DIFdelend \DIFaddbegin \DIFadd{Low latitude yield reductions are due in part to shortening of the growing season under warming and in part to the direct effects of higher temperature.
...
\DIFaddbegin \DIFadd{We show some additional cases in Supplemental Material. As noted previously, the A1 adaptation simulations involve significantly moderated temperature impacts relative to the A0 simulations shown here (Supplemental Figure S14).  
...
However, note that the }\DIFdelend \DIFaddbegin \DIFadd{which can then be driven by arbitrary climate scenarios.
