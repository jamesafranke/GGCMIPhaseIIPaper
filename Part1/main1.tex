...
The responses highlighted here are qualitatively similar across all crops included in this study (Supplementary Figures SX - X). 
...
(For soybeans, temperature effects are more complex; see Supplementary Figure XX.) 
...
(Compare Figure \ref{fig:soywheat}a for soy and Supplementary Figure XX for wheat).
