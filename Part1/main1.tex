...
including CO$_2$, temperature, precipitation, and applied nitrogen (``CTWN''), as well adaptation to shifting growing seasons. 
...
%--------- SAVE for section on adaptation protocol ------
...
The models using WFDEI use the precipitation data set that is bias-corrected against the CRU data set \citep{weedon2014wfdei}.
Very small differences exist in temperature and precipitation levels between AgMERRA and WFDEI for the relevant crop production areas (Figures Sxx and Syy \textcolor{red}{I've put these at the end of the subdocs, but it does throw some error...}.
