...
1) validation - reiterate something about that. In historical simulations, year-over-year correlations in modeled and actual country-level yields are comparable to previous process-based model intercomparison projects.
Models generally agree on changes driven by all factors outside the high latitudes (where models differ in treatment of crop response to current cold conditions).
Interactions between major yield drivers (temperature and precipitation in Figure 5, precipitation and CO$_2$f in Figure 6) generally follow expectations.
...
Preliminary results shown here highlight some of the insights provided by the simulation exercise and lend confidence in the models.
1) validation - reiterate something about that. In historical simulations, year-over-year correlations in modeled and actual country-level yields are ... 
...
3) interactions between major factors (temperature and precipitation in Figure 5, precipitation and CO$_2$f in Figure 6) generally follow expectations.
