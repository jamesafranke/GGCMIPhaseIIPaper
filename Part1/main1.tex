...
Note however that the models used in this exercise cannot not simulate some potential climate-related yield changes: those due to factors such as pests, disseases, and weeds.
