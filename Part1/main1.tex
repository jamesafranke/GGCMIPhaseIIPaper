...
The initial GGCMI Phase I \citep{Elliott2015, muller_global_2017} compared harmonized yield simulations over the historical period, with primary goals of model evaluation and understanding sources of uncertainty (including model parameterization, weather inputs, and cultivation areas). See also \citet{folberth2016, porwollik_spatial_2016} for more information. 
...
(Note that several models do not output the anthesis date.)
...
For example, global correlation coefficients for maize in Phase I and Phase II are 0.89 and 0.74, respectively; for wheat 0.67 and 0.64, and for soybeans 0.64 and 0.59.
