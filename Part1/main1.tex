...
Total available soil moisture in root zone (growing season sum, basis for computing average soil moisture) & trzpah2o\_<crop>  & mm yr$^{-1}$                    \\
...
\label{table:models}
	\begin{tabular}{p{6cm} p{1cm} p{1cm} p{1cm} p{1cm} p{1cm} p{1cm} p{1.5cm}}
        \tophline
        {\textbf{Model (Key Citations)}}&{\textbf{Maize}}&{\textbf{Soy}}&{\textbf{Rice}}&{\textbf{Winter wheat}}&{\textbf{Spring wheat}}&{\textbf{N dim.}}&{\textbf{Simulations per crop (A0/A1)}}\\ \middlehline
        {\textbf{APSIM-UGOE},    \citet{KEATING2003267, HOLZWORTH2014327}} & {X} & {X} & {X} & {X} & {X} & {X} & {44/36}\\ \middlehline
        ...
        {\textbf{PROMET},        \citet{Hank2015, MAUSER2015}} & {X} & {X} & {X} & {X} & {X} & {X\dag} & {261/232}\\ \middlehline
