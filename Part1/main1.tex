...
\subsection{Harmonization between models}
While 10 of the 12 models participating in GGCMI Phase II use the AgMERRA historical daily climate inputs, two models require sub-daily input data or long wave radiation and use alternative baseline climate inputs. PROMET uses the ERA-Interim reanalysis \citep{dee2011era} in order to include long-wave, and JULES uses a version of ERA-Interim with modified precipitation, the 3-hour WFDEI \citep{weedon2014wfdei}.  
