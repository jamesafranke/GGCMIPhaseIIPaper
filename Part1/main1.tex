...
\documentclass[gmd, final]{copernicus} %final manuscript
\usepackage{url}
...
$[model]\_[climate]\_hist\_fullharm\_[variable]\_[crop]$ \\
$\_global\_annual\_[start-year]\_[end-year]\_[C]\_[T]$ \\
$\_[W]\_[N]\_[A].nc4$ 
...
script is available at https://github.com/RDCEP/ggcmi/.
