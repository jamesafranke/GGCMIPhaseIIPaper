...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{document}
\centering{\bf {\large Supplemental Material 1} \\
...
\begin{figure*}[ht]
  \centering
  \includegraphics[width = 16.3cm]{figures/LPJMLRCP85comp_30N.png}
  \caption{
...
\begin{figure*}[ht]
  \centering
  \includegraphics[width = 16.3cm]{figures/LPJMLRCP85comp_tropics.png}
  \caption{
  Same as main text Figure 9 except now only for crops between 30N and 30S.
  }
  \label{fig:lpjmlrcp}
\end{figure*}

\clearpage
\section{A1 Emulator products}

\begin{figure*}[ht]
  \centering
  \includegraphics[width = 16.3cm]{figures/em_CTWN_all_crops_A1.png}
  \caption{
