...
Figure \ref{fig:var} shows examples of changes in variability across representative climate model in the CMIP-5 archive. We use the HadGEM2 model for assessing the ability of GGCMI emulators to reproduce yield changes simulated under more realistic climate projections.
\end{flushleft}
