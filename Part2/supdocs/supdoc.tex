...
\begin{figure}[h!]
  ...
  \caption{
  Change in hemispheric-summer variability for some CMIP-5 models for an abrupt 4x CO$_2$ forcing. Heatmap shows the ratio in standard deviation in temperature compared to preindustrial values. 
...
\begin{figure}[h!]
  ...
  \caption{
  Illustration of the factors affecting yields in more realistic climate scenarios for soy. Same convention main text Figure 11. The split in PROMET panel \textbf{a} illustrates the differences in spatial patterns of temperature change across climate models. 
  }
\end{figure}
