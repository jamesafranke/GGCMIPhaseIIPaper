...
An alternative approach to emulation involves the constructions a training set of multiple stationary scenarios in which input parameters are systematically varied. 
...
In this paper we describe a crop model emulator developed from a new simulation output dataset as of the Global Gridded Crop Model Intercomparison (GGCMI) Phase II experiment under the Agricultural Model Intercomparison and Improvement Project (AgMIP) \citep{ROSENZWEIG2013, Rosenzweig2014}. 
The emulators are developed from a training set consiting of the largest 
