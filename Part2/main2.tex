...
\textcolor{red}{The central metric in assessments of climate change impacts on crop yields is the change in multi-annual means \citep[e.g.][]{Schlenker2009, Challinor2014, Rosenzweig2014, Muller_2015_implications, zhao2016plausible, hsiang_estimating_2017} }
...
In Figure \ref{fig:globe_em}, we show emulated maize responses for 3 crop models under the RCP8.5 scenario, using output from 3 climate models from the CMIP-5 archive (HadGEM2-ES, GFDL-ESM2M, IPSL-CM5A-LR). 
...
\textcolor{red}{While we tested the importance of differnt dimesions across area with current cultivation, future work may wish to test if these relationships are constant across space and in regions without current cultivation.}
