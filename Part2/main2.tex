...
While an emulator that captures the response of a process-based crop models in a lightweight form  will never be more \textit{accurate} then its parent model, it can have multiple advantages over a numerical simulation. 
