...
The complete protocol for a modeling group involves up to 20,000 years of global simulated output for rainfed crop and growing-season case; or \textcolor{red}{40,000} years across all simulations for a single modeling group. 
...
\begin{figure}[ht]
    ...
    \caption{Global emulated damages for maize on currently cultivated lands for three example GGCMI Phase II models. Models not shown: CARAIB, EPIC-TAMU, JULES, GEPIC, LPJ-GUESS, and PEPIC.
