...
Climatological mean yields are a central metric in climate change impact analysis and relevant in many analyses of effects of climate change impacts, such as in integrated climate change impact assessments.
...
Table \ref{table:ASE} shows the yield-change-normalized RMSE for rainfed crops in all models over currently cultivated land, both in selected major producing regions and in the global average. We include all simulations in th CTWN space and report the average error value in Table \ref{table:ASE}. 
