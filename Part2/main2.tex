...
The emulator is also useful for investigating the contributions of the different major climate drivers to yield outcomes.
...
Including precipitation changes tends to reduce yields further and increase the spread across climate model projections. 

PROMET, the quantitatively most difficult model to emulate for Maize is shown to illustrate that ... its not that bad comparatively speaking.
