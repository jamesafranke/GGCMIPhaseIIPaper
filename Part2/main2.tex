...
Differences between the emulation and simulation are similar to the spread across climate models for a single crop model, but much lower than the differences across climate models. 
With CO$_2$ included, the climate model response spread increases considerably. Note that no direct comparison to the simulations is possible in this case.
