...
The year-over-year responses are generally quantitatively distinct from (and larger than, in the case of temperature) the climatological mean responses in the GGCMI Phase II simulation output dataset. 
