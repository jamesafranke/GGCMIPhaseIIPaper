...
\begin{document}
\title{Globally-gridded 30-year mean climatological crop model emulators for yield (and irragation water demand)} %and irrigation water demand
...
\begin{figure}[ht]
\centering
   \includegraphics[width=8.3cm]{figures/feature_selection.png}
