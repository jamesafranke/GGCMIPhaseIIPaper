...
\begin{figure*}[ht]
	...
	Soy as an efficient atmospheric nitrogen-fixer is relatively insensitive to nitrogen, and rice is not generally grown in water-limited conditions. Uncertainty is highest for spring wheat in general and for the CO$_2$ response for the wheats and soy.}
	\label{fig:all_dims}
\end{figure*}
