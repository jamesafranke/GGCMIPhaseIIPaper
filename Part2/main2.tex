...
Models inputs are harmonized wherever possible including planting days (which vary spatially) and growing season lengths. 

Each simulation scenario is run for 30 years over the historic weather variability for the period of 1981-2010.
Most crop models utilize the AgMERRA historical daily climate data product \citep{Ruane2015}.
PROMET uses ERA-Interim reanalysis \citep{dee2011era} and JULES uses a bias-corrected version of ERA-Interim, the 3-hour WFDEI (WATCH-Forcing-Data-ERA-Interim) \citep{weedon2014wfdei}, 
...
The historical rainfall differs across the climate products used in the 
...
We focus on yield emulators with no-growing season adaptation here. 
...
The GGCMI Phase II model experiment parameter sweep was designed to provide a training dataset for emulation that is structured in a way that allows temporally aggregation.
...
Nonlinear yield responses are well-documented in observations for temperature and water perturbations (e.g.\ \citet{Schlenker2009} for T and \citet{He2016} for W). 
