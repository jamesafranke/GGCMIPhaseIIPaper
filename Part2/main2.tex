...
Section \ref{S:2} summarizes the rationale of the GGCMI Phase~2 CTNW-A experiment as described in full detail by \citet{franke2020ctwnexperiment} and proposes the rationale for climatological-mean yield emulation
...
While we tested the importance of differnt dimesions across area with current cultivation, future work may wish to test if these relationships are constant across space and in regions without current cultivation.
