...
\begin{document}
\title{GGCMI Phase II global gridded crop model emulators of yield and irrigation water demand}
...
In the following sections we describe the training dataset, the model statistical specification, and some evidence of model fidelity.
...
Emulators for irrigated yields are separate from rainfed and therefore irrigation water demand is only provided for irrigated simulations. 
Each crop model emulator consists of six sets of fits.
