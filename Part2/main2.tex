...
\Author[7,14]{Wenfeng}{Liu}
\Author[15]{Stefan}{Olin}
\Author[5,16]{Meridel}{Phillips}
\Author[17,18]{Thomas A.\ M.}{Pugh}
...
\affil[15]{Department of Physical Geography and Ecosystem Science, Lund University, Lund, Sweden}
\affil[16]{Earth Institute Center for Climate Systems Research, Columbia University, New York, NY, USA}
\affil[17]{School of Geography, Earth and Environmental Sciences, University of Birmingham, Birmingham, UK.}
\affil[18]{Birmingham Institute of Forest Research, University of Birmingham, Birmingham, UK.}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
While changes in temperature distributions can strongly affect crop yields \citep[e.g.][]{Roberts2017}, those in precipitation distributions have less effect since crops respond not to rainfall but to soil moisture, which integrates on timescales of weeks or even months \citep[e.g.][]{potter2005effects}. 
...
For example, \cite{Urban2012} show 20\% increase per degree K in varaince in maize yields in the U.S. under climate change.
In the GGCMI simulations, higher sensitivity in conditions of extreme climate stress results in greater year-to-year variance in yields for all crops except maize. 
...
Precipitation changes introduce some noise (because climate models have different P response for a given T)
The emulator constructed from the GGCMI perturbed mean training set reliably reproducing a realistic scenario indicating that the temperature distribution within the growing season is relatively insignificant when compared to the mean change.
...
Emulation based on GGCMI climatological mean shifts is useful for realistic scenarios and emulator fidelity uncertainty is small compared to climate model differences and tiny compared to intermodel differences
