...
\Author[9]{Tobias}{Hank}
\Author[10,11]{R.\ Cesar}{Izaurralde}
\Author[7]{Ingrid}{Jacquemin}
\Author[10]{Curtis}{Jones}
%\Author[12]{Marian}{Koch}
\Author[2,12]{Michelle}{Li}
\Author[7,13]{Wenfeng}{Liu}
\Author[14]{Stefan}{Olin}
\Author[5,15]{Meridel}{Phillips}
\Author[16,17]{Thomas A.\ M.}{Pugh}
\Author[10]{Ashwan}{Reddy}
\Author[8]{Karina}{Williams}
\Author[9]{Florian}{Zabel}
...
\affil[9]{Department of Geography, Ludwig-Maximilians-Universit\"{a}t, Munich, Germany}
\affil[10]{Department of Geographical Sciences, University of Maryland, College Park, MD, USA}
\affil[11]{Texas Agrilife Research and Extension, Texas A\&M University, Temple, TX, USA}
%\affil[12]{Georg-August-University G\"{o}ttingen, Tropical Plant Production and Agricultural Systems Modeling, G\"{o}ttingen, Germany}
\affil[12]{Department of Statistics, University of Chicago, Chicago, IL, USA}
\affil[13]{EAWAG, Swiss Federal Institute of Aquatic Science and Technology, D\"{u}bendorf, Switzerland}
\affil[14]{Department of Physical Geography and Ecosystem Science, Lund University, Lund, Sweden}
\affil[15]{Earth Institute Center for Climate Systems Research, Columbia University, New York, NY, USA}
\affil[16]{School of Geography, Earth and Environmental Sciences, University of Birmingham, Birmingham, UK.}
\affil[17]{Birmingham Institute of Forest Research, University of Birmingham, Birmingham, UK.}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
We provide separate emulations of not only irrigated and rainfed yields but also irrigation water demand in both the A0 and A1 growing season, meaning that each model and crop combination results in six regressions. (See Supplementary Material SXX for more information on additional cases not shown.)
...
\begin{figure*}[ht]
    ...
    Figures shows emulated yield changes for maize on currently cultivated land under RCP8.5 (relative to 1980-2010 mean) for three representative crop models, with changes to T only (\textbf{a}), to T and P (\textbf{b}), and to T, P, and CO2 (\textbf{c}).
...
The emulated crop model yield responses to business-as-usual climate change (Representative Concentration Pathway (RCP) 8.5) are shown in Figure \ref{fig:globe_em} for 29 climate models from the CMIP-5 archive \citep{Taylor2012} at the decadal scale.
