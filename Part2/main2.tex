...
We construct an emulator of 30-year climatological mean yields because most assessment models project impacts at some aggregate temporal scale (decades) or utilize some temporally aggregated climate projection.
...
%Disadvantages of the parameter sweep approach include neglecting changes in seasonality and some implausible combinations of input settings (e.g. colder temperatures and higher CO$_2$).
...
Emulation in the method proposed here is only possible  when crop yield responses are sufficiently smooth and continuous to allow fitting with a relatively simple functional form, but this condition largely holds in the GGCMI Phase II simulations. 
...
Crop yield responses to changes in weather and management are geographically diverse, even in high-yield and high-cultivation areas. 
