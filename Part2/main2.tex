...
\introduction
\label{S:1}
Efforts to project climate change impacts often combine models from several different disciplines under a unified economic framework to provide a total cost of climate change or total cost of carbon. Where the so-called Integrated Assessment Models (IAMs) excel in breadth they lack in depth. The detailed numerical models used by the different disciplines studying climate change cannot be directly integrated into IAMs because of simulation framework or computational cost. Process-based crop simulation models provide many advantages for projecting the impacts of climate change on agriculture but fall into this category of models difficult to integrate into larger economic assessments. Statistical models on the other hand, often lack important features of process-based models including future CO$_2$ direct fertilization and potential changes in management, but often provide analytical forms that can be brought directly into an IAM.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\codedataavailability{The polynomial emulator parameter matrices for all crop model emulators are available at https://doi.org/10.5281/zenodo.2605374.}
