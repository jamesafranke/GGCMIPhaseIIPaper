...
On the one hand, process-based crop simulation models (numerical models that simulate the process of photosynthesis and the biology and phenology of individual crops) provide some advantages for projecting the impacts of climate change on agriculture including a clear mechanism for linking climate to yield outcomes.
...
In the following sections we describe the training dataset, the emulator statistical specification, and some evidence of model reliability.
