...
\centering
   ...
   \caption{Example showing climatological mean yields and distribution of yearly yields for three 30-year scenarios. Figure shows rain-fed maize for a representative high-yield region (a single grid cell in northern Iowa) from the pDSSAT model, for the baseline climatology (1981-2010) and for scenarios with temperature shifted by T+3 and T+6 K, with other variables held at baseline values.  The stronger year-over-year temperature response with higher temperatures seen in Figure \ref{fig:yearvclim} is manifested as a larger variance in annual yields at T+6. In this work we emulate not the year-over-year distributions but the climatological mean response (dashed vertical lines / black dots).}
   \label{fig:yearly}
\end{figure}
...
\subsection{Climatological mean yield emulation procedure}
...
\subsubsection{Feature selection procedure}
...
\subsection{Assessing emulator performance}
...
\section{Simulation model validation results}
\begin{figure*}[!hb]
    \centering
