...
early efforts in 2015 \citep{Markowski2015, Pirttioja2015}, and several recent studies in 2018 \citep{FRONZEK20182, Snyder2018, RUIZRAMOS2018}. All three studies sample multiple perturbations to % XX check this !!
temperature and precipitation (with \citet{Snyder2018} and \citet{RUIZRAMOS2018} adding CO$_2$ as well), in 132 and 99 different combinations, respectively, and take advantage of the structured training set to construct emulators of climatological mean yields, omitting year-over-year variations. All three studies are limited in other aspects, however: both simulate only a handful of individual sites, and \citet{FRONZEK20182} and \citet{} simulates only wheat (over several models), while \citet{Snyder2018} analyzes four crops but with a single model (GCAM). 
