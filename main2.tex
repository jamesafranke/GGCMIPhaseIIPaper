...
The main limitation in these stydies is of geogphaic extext with each study focusing on a limited number of sites, and \citet{FRONZEK20182} and \citet{RUIZRAMOS2018} simulat only wheat (over several models), while \citet{Snyder2018} analyzes four crops but with a single model (GCAM). 
