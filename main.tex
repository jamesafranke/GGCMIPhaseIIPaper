...
\label{table:inputs} 
    \begin{tabular}{lcc} 
        ...
        {Temperature (T)} & {-1, \textbf{0}, 1, 2, 3, 4, 5*, 6} & {$^{\circ}$C}\\ \middlehline \vspace{1mm}
