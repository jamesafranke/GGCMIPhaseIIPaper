...
Systematic parameter sweep offers advantages over analyses on small number of realistic scenario in which climate varies over time. 

- allows distinction between year over year and climatological changes, which can be different. 

- removes correlation of key variables which makes them difficult to disentangle in realistic scenarios
