...
\codedataavailability{The resulting parameter matrices for all crop model emulators are available on request {\color{red} give location?}, as are the raw simulation data and a Python application to emulate yields.}
...
\Authorcontribution{J.E., C.M, and A.R. designed the research. C.M., J.J., J.B, P.C., M.D., P.F., C.F., L.F., M.H., C.I., I.J., C.J., N.K., M.K., W.L., S.O., M.P., T.P., A.R., X.W., K.W., and F.Z. performed the simulations. J.F., J.J., A.S, and M.L. performed the analysis and J.F. and E.M. prepared the manuscript.}
