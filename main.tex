...
\label{table:MSE}
\begin{tabular}{lcccccccccc} \tophline
\textbf{Model} & \textbf{Maize} & {} & \textbf{Soy} & {} & \textbf{Rice} & {} & \textbf{W_Wheat} & {} & \textbf{S_Wheat} & {}\\ \middlehline
{}                   & {BR}  & {LM}  & {BR}       & {LM} & {BR}        & {LM} & {BR}           & {LM} & {BR}           & {LM}\\ \middlehline
{\textbf{CARAIB}}    & {xxx} & {xxx} & {xxx}     & {xxx} & {xxx}      & {xxx} & {xxx}         & {xxx} & {xxx}         & {xxx}\\ \middlehline
{\textbf{EPIC-TAMU}} & {xxx} & {xxx} & {xxx}     & {xxx} & {xxx}      & {xxx} & {xxx}         & {xxx} & {xxx}         & {xxx}\\ \middlehline
{\textbf{JULES}}     & {xxx} & {xxx} & {xxx}     & {xxx} & {xxx}      & {xxx} & {xxx}         & {xxx} & {xxx}         & {xxx}\\ \middlehline
{\textbf{GEPIC}}     & {xxx} & {xxx} & {xxx}     & {xxx} & {xxx}      & {xxx} & {xxx}         & {xxx} & {xxx}         & {xxx}\\ \middlehline
{\textbf{LPJ-GUESS}} & {xxx} & {xxx} & {xxx}     & {xxx} & {xxx}      & {xxx} & {xxx}         & {xxx} & {xxx}         & {xxx}\\ \middlehline
{\textbf{LPJmL}}     & {xxx} & {xxx} & {xxx}     & {xxx} & {xxx}      & {xxx} & {xxx}         & {xxx} & {xxx}         & {xxx}\\ \middlehline
{\textbf{pDSSAT}}    & {xxx} & {xxx} & {xxx}     & {xxx} & {xxx}      & {xxx} & {xxx}         & {xxx} & {xxx}         & {xxx}\\ \middlehline
{\textbf{PEPIC}}     & {xxx} & {xxx} & {xxx}     & {xxx} & {xxx}      & {xxx} & {xxx}         & {xxx} & {xxx}         & {xxx}\\ \middlehline
{\textbf{PROMET}}    & {xxx} & {xxx} & {xxx}     & {xxx} & {xxx}      & {xxx} & {xxx}         & {xxx} & {xxx}         & {xxx}\\ \middlehline
\bottomhline
\end{tabular}
\end{table*}
