...
\citet{BLANC2015} and \citet{BLANC2017} have shown that a fractional polynomial specification is more applicable for representing simulations at the yearly level across different soil types geographically (not at the grid cell level). We do not test this specification here, and instead use a polynomial to represent the climatological-mean response at the grid cell level as it is the simplest effective specification. 
