...
We present the simulation outputs from Phase II of the GGCMI effort, a targeted experiment aimed at understanding the interaction between multiple climate variables (as well as management), and show some initial summary results from the model intercomparison project.
