...
\documentclass[esd, manuscript]{copernicus} %final
...
\affil[21]{Karlsruhe Institute of Technology, IMK-IFU, 82467 Garmisch-Partenkirchen, Germany.}
\affil[22]{School of Geography, Earth and Environmental Science, University of Birmingham, Birmingham, UK.}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\runningtitle{GGCMI Phase II}
...
% demonstrate that it is tractible to emulation
...
\begin{figure*}[h]
\centering
    \includegraphics[width=14cm]{figures/regression_areas.png}
...
\centering\tabularnewline
    \includegraphics[width=14cm]{figures/regression_model.png}
...
\codedataavailability{Code and Data are availble at blah blah blah } %% use this section when having data sets and software code available
...
\appendix
\subsection{Simulations -- Assessment}     %% Appendix A1, A2, etc.
\label{A:1}
\begin{figure*}[t]
    \centering
...
\begin{figure}[t]
\centering
    \includegraphics[width=8.3cm]{figures/error_360.png}
...
\begin{figure}[t]
\centering
    \includegraphics[width=8.3cm]{figures/em_err.png}
...
\Authorcontribution{J.E., C.M, and A.R. designed the research. C.M., J.J., J.B, P.C., M.D., P.F., C.F., L.F., M.H., C.I., I.J., C.J., N.K., M.K., W.L., S.O., M.P., T.P., A.R., X.W., K.W., and F.Z. performed the simulations. J.F., J.J., A.S, and M.L. performed the analysis. J.F. and E.M. prepared the manuscript.}
\competinginterests{The Authors declare no competing intrestes.} %% this section is mandatory even if you declare that no competing interests are present
