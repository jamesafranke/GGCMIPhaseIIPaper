...
Simulation model validation for phase II attempts to recreate the validation methods used in \citet{muller_global_2017} for the first phase of the GGCMI project. In this case however, the models are not run on best approximation of management levels (namely nitrogen application level) by country. 
