...
When reduced to the polynomial, the parameter matrices become portable and computing yields computationally cheap, even at the half degree grid cell level.
